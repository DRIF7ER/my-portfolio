...
const Projects: React.FC = () => {
  ...
  const projectsData = [
    ...
    },
    {
      ...
      githubLink: "https://github.com/DRIF7ER/rancid-tomatillos-repeat-mine",
    },
    {
      name: "Red Horizon",
      staticImageUrl: "/assets/Red Horizon Home Page Pic.jpg",
      gifUrl: "/assets/Red Horizon GIF.gif",
      techStack: ["React", "typescript", "Cypress", "REST API", "Vite.js", "React Router"],
      description: "Mars exploration app for curious learners to discover images of the surface features of Mars, explore its moons, and images from the Mars rover expeditions.",
      contributions: "This group project took 3 Turing students roughly 8 days or 45 hours to complete. We were in our 14th week of intensive front-end web development training.",
      githubLink: "https://github.com/DRIF7ER/red-horizon-mine",
    },
    // {
    //   name: "Chess War",
  ...
  return (
    <section id="projects" className="py-16 bg-emerald-100">
